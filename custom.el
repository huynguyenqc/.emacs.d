...
\"###########.######\" };")) t)
 ...
 '(package-selected-packages
   (quote
    (color-theme-buffer-local color-theme-modern arjen-grey-theme apropospriate-theme django-theme almost-mono-themes abyss-theme atom-one-dark-theme basic-theme distinguished-theme ample-zen-theme badger-theme gruber-darker-theme alect-themes spacemacs-theme arc-dark-theme color-theme darkokai-theme atom-dark-theme smart-mode-line-powerline-theme afternoon-theme twilight-theme zerodark-theme dracula-theme js-comint js-mode xref-js2 js2-refactor js2-mode elixir-mode htmlize ggtags highlight-symbol rg helm-projectile helm-rg elisp-slime-nav swiper-helm helm-config neotree doom-themes jedi company-lsp lsp-python flycheck-pyflakes paredit elpy lsp-ui highlight-parentheses lsp-mode flycheck python immaterial-theme material-theme pyenv-mode python-mode rainbow-mode jdee multi-term grep-a-lot nyan-mode solarized-theme avy evil magit helm)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:stipple nil :background "#1c1e1f" :foreground "#d6d6d4" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :foundry "PfEd" :family "Tlwg Mono"))))
 '(neo-dir-link-face ((t (:foreground "steel blue" :weight bold))))
 '(neo-expand-btn-face ((t (:foreground "yellow"))))
 '(neo-file-link-face ((t (:foreground "dark orchid" :slant italic))))
 '(neo-root-dir-face ((t (:foreground "dark orange" :weight bold))))
 '(scroll-bar ((t nil))))
